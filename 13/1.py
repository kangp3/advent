...
def main(test=False):
    ...
    def solve_puzzle(puzzle):
        ...
        a_presses = int((prize[0] - (btn_b[0] / btn_b[1] * prize[1])) / (btn_a[0] - btn_b[0] / btn_b[1] * btn_a[1]))
        b_presses = int((prize[0] - a_presses * btn_a[0]) / btn_b[0])

        b_presses = int((prize[0] - (btn_a[0] / btn_a[1] * prize[1])) / (btn_b[0] - btn_a[0] / btn_a[1] * btn_b[1]))
        a_presses = int((prize[0] - b_presses * btn_b[0]) / btn_a[0])
        ...
        return int(a_presses) * 3 + int(b_presses) if close_enough(a_presses) and close_enough(b_presses) else None
